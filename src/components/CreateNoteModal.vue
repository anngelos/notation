  ...
  <div
    ...
    <div class="border border-gray-900 modal-container bg-white w-11/12 md:max-w-md mx-auto rounded shadow-lg z-50 overflow-y-auto">
      <div class="modal-content py-4 text-left px-6">
        ...
        <form class="my-5 flex flex-col space-y-4">
          <input type="text" placeholder="titulo" class="mb-3 py-1 px-4 border border-gray-400 focus:outline-none rounded-md focus:ring-1 ring-slate-500" />
          <textarea maxlength="127" placeholder="digite o conteúdo da sua nota aqui" name="note-content" cols="30" rows="7"
